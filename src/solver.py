...
class Solver:
    ...
    def __rnd_single_move(self):
        r = rnd.randint(0, len(self.single_moves) - 1)
        return [self.single_moves[r]]

    def __rnd_permutation(self):
        r = rnd.randint(0, len(self.permutations) - 1)
        return self.permutations[r]

    def __rnd_rotation(self):
        r = rnd.randint(0, len(self.rotations) - 1)
        return [self.rotations[r]]

    def __rnd_orientation(self):
        r = rnd.randint(0, len(self.orientations) - 1)
        return [self.orientations[r]]
